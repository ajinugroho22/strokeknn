...
//cek data sudah ada atau blm
  ...
  $byk=$dtl->cekdata($umur,$jk,$kerja,$hiper,$jantung,$tinggal,$rokok,$nikah,$bmi,$gula);
  //jika username blm digunakan
  if($byk==0){
      //memasukkan data baru
      $dtl->masuk($jk,$umur,$gula,$bmi,$hiper,$jantung,$rokok,$tinggal,$kerja,$nikah,$class);
      echo "<script>location='datalatih.php'</script>";
  }
  else{
    echo "<script>alert('Data Sudah Ada')</script>";
    echo "<script>location='tambahlatih.php'</script>";
  }
}
